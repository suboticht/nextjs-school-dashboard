    ...
    <div className="bg-white rounded-md p-4">
        ...
        <div className="flex flex-col gap-4 mt-4">
            <div className="flex flex-col gap-3 rounded-md bg-HTSkyLight p-5">
                ...
                <p className="text-sm text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta cum ipsum quo voluptas dolorem cumque. Maiores veritatis ad.</p>
            </div>
