...
const UserCard = ({ type, size } : { type : string, size: "sm" | "lg" }) => {
  return (
    <div className={`flex ${size === "lg" ? "w-[48%] md:w-full lg:w-[49%]" : "flex-1"} flex-col justify-between items-start gap-4 rounded-2xl odd:bg-HTPurple even:bg-HTYellow min-w-[130px] p-4`}>
