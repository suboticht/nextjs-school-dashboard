...
export default function Pagination() {
  return (
    <div className="flex justify-between items-center my-6 md:px-6">
      <button disabled className='bg-slate-200 text-slate-500-400 px-2 text-sm md:px-3 py-1 rounded-md disabled:opacity-50 disabled:cursor-not-allowed'>Prev</button>
      ...
      <button className='bg-slate-200 text-slate-500-400 px-2 text-sm md:px-3 py-1 rounded-md'>Next</button>
    </div>
  )
}
